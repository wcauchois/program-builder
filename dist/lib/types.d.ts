...
interface IRequiredKeywordArgumentOptions<K extends string> extends IKeywordArgumentCommonOptions<K> {
    required: true;
}
interface IOptionalKeywordArgumentOptions<K extends string> extends IKeywordArgumentCommonOptions<K> {
    required?: false;
}
declare type KeywordArgumentOptions<K extends string> = IRequiredKeywordArgumentOptions<K> | IOptionalKeywordArgumentOptions<K>;
